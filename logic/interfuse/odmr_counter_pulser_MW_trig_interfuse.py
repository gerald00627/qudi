...
class ODMRCounterMWTrigInterfuse(GenericLogic, ODMRCounterInterface, MicrowaveInterface):
    ...
    def set_up_odmr_clock(self, clock_frequency=None, clock_channel=None, pi_pulse= pi_pulse_len):
        ...
        # d_ch = clear(d_ch)
        # block_1.append(init_length = 0.3e-6, channels = d_ch, repetition = 1)
    ...
    def count_odmr(self, length = 100):
        ...
        # histind = self._sc_device.recorder.getHistogramIndex()
        # print(histind)


        # # self._mw_device._connection.write(':LIST:RESET')
        #     self._mw_device._connection.write(':SWEEP:RESET:ALL')
        ...
        # x=self._mw_device._connection.query(':LIST:INDEX?')

        self._mw_device._command_wait(':FREQ:MODE CW')
        # print(x)
        # print(self._mw_device._connection.query(':FREQ:MODE?'))
        ...
        # self._mw_device._connection.write(':OUTP:STAT ON')
        # self._mw_device._connection.write('*WAI')
        # self._mw_device._command_wait(':FREQ:MODE LIST')
        ...
        # self._mw_device._connection.write(':OUTP:STAT OFF')
        self._mw_device._command_wait(':FREQ:MODE CW')

        # self._mw_device._command_wait(':OUTP:STAT OFF')
